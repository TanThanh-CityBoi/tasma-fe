...
function* getAllTasksByProjectSaga(action) {
  try {
    ...
    const backLog = yield call(() =>
      taskService.getAllTasksByProject(projectId, "BACKLOG")
    );
    const inProgress = yield call(() =>
      taskService.getAllTasksByProject(projectId, "IN PROGRESS")
    );
    const underReview = yield call(() =>
      taskService.getAllTasksByProject(projectId, "UNDER REVIEW")
    );
    const cancelled = yield call(() =>
      taskService.getAllTasksByProject(projectId, "CANCELLED")
    );
    const done = yield call(() =>
      taskService.getAllTasksByProject(projectId, "DONE")
    );

              ...
              <div className="jira">
                 ...
                 <div className="main">
                    ...
                    <h4 style={{ color: "#172B4D", fontWeight: "bold" }} className="mt-3">
                       {restParam.title} {restParam.title === "Board" && project ? ` - ${project?.name}` : " "}
                    </h4>
                    <span className="text-danger font-weight-bold">
                       {restParam.title === "Board" && !project ? "Empty Project" : ""}
                    </span>
                    <p className="mb-4 text-primary font-weight-bold">
                       {restParam.title === "Board" && !project ? "Create new project in tab Project Management" : ""}
                    </p>

...
export default function Board(props) {
  ...
  let { backLog, inProgress, underReview, cancelled, done } = useSelector(
                 ...
                 <Droppable droppableId={taskListDetail.status} key={index}>
                    {(provided) => {
                       return (
                          ...
                          >
                             <div
                                className={`card-header bg-status-${taskListDetail.key} d-flex justify-content-between`}
                                style={{ color: "#f9fafb" }}
                             >
                                <span style={{ fontWeight: 500, fontSize: "14px" }}>{taskListDetail.title}</span>
                                <span style={{ fontWeight: 500, fontSize: "13px" }}>
                                   Number: {taskListDetail?.items?.length}
                                </span>
                             </div>
                             <ul
                                ref={provided.innerRef}
                                            ...
                                            return (
                                               ...
                                               >
                                                  ...
                                                  <div>
                                                     ...
                                                     task?.status !== "DONE" ? (
                                                        <i style={{ fontSize: "12px", color: "#e91e63" }}>
      ...
      <div className="info" style={{ display: "flex" }}>
        ...
        <div style={{ marginLeft: 20 }} className="ml-5">
          <button
            ...
            style={{ height: "37px", backgroundColor: "#6675df" }}
            type="button"
            onClick={() => {
              dispatch({

...
function ProjectSetting(props) {
  ...
  const renderProjectCategories = () => {
    return projectCategories.map((projectCategory, index) => {
      return (
        <option key={index} value={projectCategory.id}>
    ...
    <form onSubmit={handleSubmit}>
      <div style={{ width: "60%" }} className="mt-4">
        ...
        {/* <div className="mb-3">
               ...
               <input className="form-control" name="url" placeholder="https://github.com" onChange={handleChange} />
            </div> */}
        <div className="mb-3">
...
const CreateProjectWithFormik = withFormik({
  ...
  mapPropsToValues: (props) => {
    return {
      ...
      url: "",
      description:
        "<p>Task management website built with ReactJS and NestJS</p>",

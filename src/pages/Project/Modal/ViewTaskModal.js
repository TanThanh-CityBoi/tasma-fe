...
function ViewTaskModal(props) {
   ...
   const [timeTrackingSpent, setTimeTrackingSpent] = useState(task?.timeTrackingSpent || 0);
   const [timeOriginalEstimate, setTimeOriginalEstimate] = useState(task?.originalEstimate || 0);
   const [taskReporter, setTaskReporter] = useState(task?.reporter?.login || "");

   const dispatch = useDispatch();
   console.log("🚀 ~ file: ViewTaskModal.js:29 ~ ViewTaskModal ~ task:", task);
            ...
            <div className="comment-item" key={index}>
               <div className="display-comment" style={{ display: "flex" }}>
                  ...
                  <div>
                     ...
                     <p style={{ marginBottom: 0, color: "172B4D" }}>{comment.content}</p>
                           ...
                           <div className="block-comment mt-4" style={{ display: "flex" }}>
                              <div className="avatar">
                                 {userLogin.imageUrl === "" || userLogin.imageUrl === null ? (
                                    ...
                                    <Avatar src={userLogin.imageUrl} style={{ width: 40, height: 40 }} />
                                 )}
                              </div>
                     ...
                     <div className="col-4">
                              ...
                              {usersAssign?.map((user, index) => {
                                 ...
                                 return (
                                    <Tag className="mt-2" key={index}>
                                       <span>{isLongTag ? `${user.login.slice(0, 10)}...` : user.login}</span>
                                       <i
                        ...
                        <div className="reporter mt-3">
                           ...
                           <div>
                              <div style={{ display: "flex" }} className="item">
                                 <div className="avatar">
                                    <img
                                       src="https://res.cloudinary.com/fpt-food/image/upload/v1639680442/FPT%20FOOD/Jira_Bugs_Clone/spiderman_z2e5kw.jpg"
                                       alt="avatar.jpg"
                                    />
                                 </div>
                                 <div className="name">
                                    <div className="ml-1 mt-1 pr-1">{taskReporter || task?.reporter?.login}</div>
                                 </div>
                              </div>
                        ...
                        <div className="estimate">
                           ...
                           <Input
                              type="datetime-local"
                              name="dueDate"
                              value={task?.dueDate ? format(new Date(task?.dueDate), "yyyy-MM-dd HH:ss") : ""}
                              onChange={(e) => {
                              ...
                              onChange={(e) => {
                                 ...
                                 dispatch({
                                    ...
                                    taskUpdate: {
                                       ...
                                       timeTrackingRemaining: originalEstimate - task?.timeTrackingSpent,
                                    },
                                 });
                              ...
                              onChange={(e) => {
                                 ...
                                 dispatch({
                                    ...
                                    taskUpdate: {
                                       ...
                                       timeTrackingRemaining: task?.originalEstimate - timeTrackingSpent,
                                    },
                                 });
                        ...
                        <div style={{ color: "#929398" }}>
                           Create at:{" "}
                           {task?.createdDate ? format(new Date(task.createdDate), "dd-MM-yyyy __ HH:mm") : ""}
                        </div>
                        <div style={{ color: "#929398" }}>
                           Update at:{" "}
                           {task?.lastModifiedDate
                              ? format(new Date(task.lastModifiedDate), "dd-MM-yyyy __ HH:mm")
                              : ""}
                        </div>
                     </div>
                  </div>
